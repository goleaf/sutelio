...
const modalConfig = computed<TwoFactorConfigContent>(() => {
    if (props.twoFactorEnabled) {
        return {
            ...
            description: t('account.two_factor.enabled_description'),
    ...
    if (showVerificationStep.value) {
        return {
            title: t('account.two_factor.confirm_code_title'),
            description: t('account.two_factor.confirm_code_description'),
            buttonText: t('common.actions.continue'),
        };
    }

    return {
        title: t('account.two_factor.setup_title'),
        description: t('account.two_factor.setup_description'),
        buttonText: t('common.actions.continue'),
    };
});
    ...
    <Dialog :open="isOpen" @update:open="isOpen = $event">
        ...
        >
            <div class="space-y-5 px-6 py-6 sm:px-8">
                <div
                    class="mx-auto w-fit rounded-full border border-orange-500/15 bg-card p-0.5 shadow-sm"
                >
                    <div
                        ...
                        <template v-else>
                            ...
                            >
                                ...
                                <span class="relative bg-card px-2 py-1">{{
                                    t('account.two_factor.manual_code')
                                }}</span>
                            </div>
                                ...
                                >
                                    ...
                                    <template v-else>
                                        ...
                                        <button
                                            ...
                                            class="relative block h-auto cursor-pointer border-l border-border px-3 hover:bg-muted focus-visible:ring-2 focus-visible:ring-orange-500 focus-visible:outline-none"
                                            :aria-label="
                                                t(
                                                    'account.two_factor.copy_manual_code',
                                                )
                                            "
                                        >
                                            <Check
