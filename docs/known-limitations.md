...
- Impact: no truthful application coverage percentage can be reported from this workstation. The complete behavioral suite still passes 667 tests / 9,330 assertions sequentially and in parallel.
