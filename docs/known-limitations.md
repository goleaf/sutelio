...
- Impact: no truthful application coverage percentage can be reported from this workstation. The complete behavioral suite still passes 762 tests / 11,359 assertions sequentially and in parallel.
