...
The fresh NativePHP 4.2 mandatory-onboarding artifact candidate is `storage/app/native-build/sutelio-android-debug.apk` at SHA-256 `9a12f0cfd7c5276bfb3fe52ddce27bb29d2e25a833a3430a6040340c00684ad9`. Its package, SDK, signature, alignment, bundle-exclusion, explicit missing-preferences fallback, mandatory migration/route contract, cold-launch, process-log, SQLite integrity, foreign-key, and 39-migration gates pass on the isolated Android 14 emulator. The reviewed tracked source/docs commit must reach `origin/main` before this exact hash is installed data-preservingly on the explicitly resolved Samsung SM-A920F running Android 10 / API 29; physical installation and final device evidence remain pending.
