...
The current NativePHP 4.2 mandatory-onboarding artifact is `storage/app/native-build/sutelio-android-debug.apk` at SHA-256 `10916bc861389d3b476d32bb95fdfff00528ce88652a1af4ee07096961819990`. Its package, SDK, signature, alignment, bundle-exclusion, mandatory migration/route contract, cold-launch, process-log, SQLite integrity, foreign-key, and 39-migration gates pass on the isolated Android 14 emulator. Exact-hash data-preserving installation on the explicitly resolved Samsung SM-A920F running Android 10 / API 29 follows tracked implementation publication.
