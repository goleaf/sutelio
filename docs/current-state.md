...
- The full behavioral suite passes 667 tests / 9,330 assertions sequentially and in parallel; PHP coverage cannot be measured on this workstation because Herd has no Xdebug or PCOV driver.
