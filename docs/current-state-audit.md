...
| PHP verification      | Pest passed 667 tests / 9,330 assertions sequentially and in parallel; Pint and Larastan level 7 passed                                                                                                                   |
| Frontend verification | 23/23 Node tests, Vue type checking, ESLint, Prettier, and production build passed                                                                                                                                        |
| Build                 | 3,477 modules in 4.11 s; main application CSS 159.22 kB / 23.65 kB gzip; application entry 87.25 kB / 22.73 kB gzip; project-detail chunk 90.58 kB / 15.93 kB gzip                                                      |
