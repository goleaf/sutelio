...
- The final ignored debug APK at `storage/app/native-build/sutelio-android-debug.apk` is 127,152,864 bytes with SHA-256 `9c1a881418553bf09d3d2641b6cd3c5a820bd594135f82ddd4e77db2f711dccb`. Its bytes match the final Gradle `app-debug.apk` exactly.
- `aapt` and `apkanalyzer` report package `com.goleaf.sutelio`, label `Sutelio`, version code 1, debug version name, min SDK 31, target/compile SDK 36, ARM64 ABI, and launcher `com.nativephp.mobile.ui.MainActivity`. The external package identity remains separate from the intentional NativePHP/JNI namespace.
