...
| PHP verification      | Pest passed 683 tests / 9,539 assertions sequentially and in parallel; Pint and Larastan level 7 passed                                                                                                                   |
| Frontend verification | 27/27 Node tests, Vue type checking, ESLint, Prettier, and production build passed                                                                                                                                        |
| Build                 | 3,484 modules in 5.87 s; main application CSS 160.56 kB / 23.76 kB gzip; application entry 87.17 kB / 22.70 kB gzip; notification chunk 19.95 kB / 6.31 kB gzip                                                        |
