...
- The complete diff and phase-owned staged diff will be inspected before commit. The unrelated concurrent `tests/Feature/BrandIdentityTest.php` worktree change is preserved and excluded from this phase's commit.
