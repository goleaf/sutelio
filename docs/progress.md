...
- The 30,231,133-byte Laravel bundle contains 13,141 entries and all 39 migrations. It excludes the host SQLite database plus first-party test/documentation trees; its generated 1,247-byte runtime environment contains only allowlisted application/native/runtime keys and no application key or external-service credential field.
