...
- A failing-first Pest contract reproduced the missing guard before implementation. The corrected activation script passes Bash syntax validation and all focused production-deployment assertions; final CI, deployment, exact active-SHA, process, database-health, HTTPS, and isolated browser evidence remain to be recorded after publication.
