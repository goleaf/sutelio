...
| -------------------- | ---------------------------------------------------------------------- | --------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ |
| PHP behavioral suite | 569 tests; 567 passed; 2 formatting-brittle failures; 3,387 assertions | 683/683 passed; 9,539 assertions                           | Adds project-operation and notification filtering, isolation, partial-query, localization, lifecycle, query-plan, and frontend architecture coverage |
| Parallel PHP suite   | Not captured                                                           | 683/683; 9,539 assertions                                  | Safe parallel execution confirmed                                                                      |
| Vite build           | 3,429 modules in 9.78 s                                                | 3,484 modules in 5.87 s                                   | Focused project and notification modules remain within the baseline build-time envelope                  |
| Application CSS      | 158.29 kB / 23.61 kB gzip baseline output                              | 160.56 kB / 23.76 kB gzip main CSS                         | Semantic notification states and responsive controls add 2.27 kB raw / 0.15 kB gzip                     |
| Application entry JS | 194.24 kB / 49.69 kB gzip                                              | 87.17 kB / 22.70 kB gzip; notification chunk 19.95/6.31 kB | Page code remains split, with the command center isolated in a bounded dynamic chunk                     |
