...
Automated brand tests prove deterministic source and generated-tree contracts, not a shipped artifact or human visual result. Browser verification must inspect title/metadata/favicon, shared/authentication logo composition, focus, forced colors, zoom, fixed-light behavior, and representative viewports. The current NativePHP 4.2 artifact was independently inspected for manifest/resources/signature/alignment/archives and clean-installed on the Android 14 emulator. Its cold launch/relaunch, SQLite sandbox integrity/foreign keys/38 migrations, resumed activity, and process-scoped logs pass; the final data-preserving replacement on the explicitly resolved Samsung SM-A920F running Android 10 / API 29 follows only after tracked upgrade publication. The deterministic brand test additionally guards removal of NativePHP request/header/cookie/response/CSRF value logging after every fresh native generation.
