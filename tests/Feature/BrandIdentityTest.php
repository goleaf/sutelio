...
$assertNoLegacyIdentity = static function (string $projectRoot) use ($legacyIdentities): void {
    ...
    $isSecretPath = static function (SplFileInfo $file, string $relativePath) use ($secretDirectoryNames, $secretExtensions): bool {
        ...
        return array_intersect($secretDirectoryNames, $pathSegments) !== []
